            ...
            <div class="spacer">
				...
				<div class="">
					...
					<h2><?php echo JHTML::link($product->link, $product->product_name); ?></h2>
					 ...
					 $im = $product->images[0]->displayMediaThumb('class="browseProductImage" border="0" title="'.$product->product_name.'" ',false,'class="modal"');
					 echo JHTML::link($product->link, $im);
                   ...
                   echo $this->currency->createPriceDiv('salesPrice', 'Новая цена: ', $product->prices);
...
<!-- 						if (!VmConfig::get('use_as_catalog') and !(VmConfig::get('stockhandle','none')=='none')){?> -->
					...
					echo JHTML::link($product->link, JText::_('COM_VIRTUEMART_PRODUCT_DETAILS'), array('title' => $product->product_name));
					?>
					</p>
