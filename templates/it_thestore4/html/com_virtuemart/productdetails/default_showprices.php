...
?>
<div class="product-price clearfix" id="productPrice<?php echo $this->product->virtuemart_product_id ?>">

    <?php if($this->product->prices[salesPrice] != $this->product->prices[priceWithoutTax]) {
    echo $this->currency->createPriceDiv('salesPrice', 'Новая цена:<br>', $this->product->prices);
    echo $this->currency->createPriceDiv('priceWithoutTax', 'Старая цена: ', $this->product->prices);
     } else {
