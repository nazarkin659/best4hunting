...
/////  Content Top Modules  ////////////////////////////////////////////////////////////////////////////////////
$content_t_module = 0;
if($this->countModules('content1')) $content_t_module += 1;
if($this->countModules('content2')) $content_t_module += 1;
if($this->countModules('content3')) $content_t_module += 1;
...
$content_b_module = 0;
if($this->countModules('content1')) $content_b_module += 1;
if($this->countModules('content2')) $content_b_module += 1;
if($this->countModules('content3')) $content_b_module += 1;
...
$middle_col_width				= 940 - $layout_leftcol_width; 

$middle_col_width2				= 940 - $layout_rightcol_width;

$middle_col_width3				= 920 - $layout_leftcol_width - $layout_rightcol_width;



$fix_copyright					= $this->countModules('footer1 + footer2 + footer3 + footer4 + footer5');
