...
dojo.addOnLoad(function(){
      ...
      new OfflajnText({
        ...
        new OfflajnImagemanager({
          ...
          active: "http://www.best4hunting.com/new//modules/mod_improved_ajax_login/themes/elegant/images/samples/ptrn3.png",
    ...
    dojo.connect(el, "change", function(){
      ...
      new OfflajnCombine({
        ...
        new FontConfigurator({
          ...
          defaultTab: "Text",
          origsettings: {"Text":{"lineheight":"normal","type":"Latin","family":"Carme","subset":"Latin","size":"12||px","color":"ffffff","tshadow":"1||px|*|1||px|*|0|*|000000b3|*|1|*|","afont":"Helvetica||1","bold":"0"}},
