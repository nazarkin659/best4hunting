...
$wsdlFilename = $vmConfig->get('soap_wsdl_order')!= "" ? $vmConfig->get('soap_wsdl_order') : WSDL_ORDER;
...
$serviceFilename = $vmConfig->get('soap_EP_order')!= "" ? $vmConfig->get('soap_EP_order') : SERVICE_ORDER;
