<?php
/**
 * Settings Controller for YjContactUS Component
 * 
 * @package    
 ...
 * Settings Controller
 */
class YjContactUSControllerYjSettings extends JController{
	 ...
	 */
	function upload(){
		$model 	= $this->getModel('yjsettings');
		$msg 	= $model->save();
		
		$this->setRedirect('index.php?option=com_yjcontactus&controller=yjsettings&view=yjsettings',$msg);
	}
	...
	function create_folder(){
		...
		$this->setRedirect('index.php?option=com_yjcontactus&controller=yjsettings&view=yjsettings');
	}
}
?>