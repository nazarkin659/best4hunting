 ...
 * @subpackage Components
 */
class YjContactUSViewYjDepartment extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_YJCONTACTUS_TITLE_NEW_DEPART') : JText::_('COM_YJCONTACTUS_TITLE_EDIT_DEPART'), 'generic.png');
		...
		if ($isNew) 
		{
			...
			{
				JToolBarHelper::apply('yjdepartment.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('yjdepartment.save', 'JTOOLBAR_SAVE');
				JToolBarHelper::custom('yjdepartment.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
			}
			JToolBarHelper::cancel('yjdepartment.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			...
			if ($canDo->get('core.create')) 
			{
				JToolBarHelper::custom('yjdepartment.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
			}
			JToolBarHelper::cancel('yjdepartment.cancel', 'JTOOLBAR_CLOSE');
		}
	}
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_YJCONTACTUS_TITLE_NEW_DEPART') : JText::_('COM_YJCONTACTUS_TITLE_EDIT_DEPART'));
