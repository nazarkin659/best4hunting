 ...
 * @since		1.6
 */
class JFormFieldpreviewheight extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput(){
		...
		$param_preview_height	= $registry->get( 'preview_height', 100 );
		...
		$value		= empty($this->value) ? $param_preview_height : $this->value;
