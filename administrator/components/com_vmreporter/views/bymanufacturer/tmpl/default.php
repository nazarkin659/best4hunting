...
js(document).ready(function(){	
	js('#submenu').find('a').each(function() {
		...
		if (menu_href.indexOf('bymanufacturers') >= 0) {
...
<div id="table-area">
	<form action="" method="post" enctype="multipart/form-data" name="adminForm" id="bymanufacturer-form" class="form-validate">
				...
				<table class="adminlist">
					<thead>
						<tr>
							...
							?>										
							<th>
								<a href="<?php echo JRoute::_('index.php?option=com_vmreporter&view=bymanufacturer&id='.$pID.'&filterby='.$th.'&dir='.$pDir)?>"><?php echo $coloums[$th] ?>
								<?php
		...
		<input  type="hidden" name="view" value="bymanufacturer"/>
