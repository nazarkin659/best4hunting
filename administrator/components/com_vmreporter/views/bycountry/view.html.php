 ...
 * View to edit
 */
class VmreporterViewBycountry extends JView
{
	...
	public function display($tpl = null)
	{
		...
		$model = JModel::getInstance("bycountry","VmreporterModel");
	 ...
	 */
	protected function addToolbar($report)
	{
		
		$report = $this->report['reports'];
		//JFactory::getApplication()->input->set('hidemainmenu', true);
		JToolBarHelper::title(JText::_('COM_VMREPORTER').': '.JText::_('COM_VMREPORTER_TITLE_BYCOUNTRY').': '.$this->report["name"], 'by-country.png');
		
		if (empty($this->item->id)) {
			JToolBarHelper::cancel('bycountry.cancel', 'JTOOLBAR_CANCEL');
		}
		else {
			JToolBarHelper::cancel('bycountry.cancel', 'JTOOLBAR_CLOSE');
		}
