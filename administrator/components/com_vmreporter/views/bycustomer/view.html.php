 ...
 * View to edit
 */
class VmreporterViewBycustomer extends JView
{
	...
	public function display($tpl = null)
	{
		...
		$model = JModel::getInstance("bycustomer","VmreporterModel");
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_VMREPORTER').': '.JText::_('COM_VMREPORTER_TITLE_BYCUSTOMER').': '.$this->report["name"], 'by-customer.png');

		if (empty($this->item->id)) {
			JToolBarHelper::cancel('bycustomer.cancel', 'JTOOLBAR_CANCEL');
		}
		else {
			JToolBarHelper::cancel('bycustomer.cancel', 'JTOOLBAR_CLOSE');
		}
