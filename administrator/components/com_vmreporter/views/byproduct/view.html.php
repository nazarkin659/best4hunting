 ...
 * View to edit
 */
class VmreporterViewByproduct extends JView
{
	protected $state;
	protected $item;
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$model = JModel::getInstance("byproduct","VmreporterModel");
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_VMREPORTER').': '.JText::_('COM_VMREPORTER_TITLE_BYPRODUCT').': '.$this->report["name"], 'byproduct.png');
