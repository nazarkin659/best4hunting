 ...
 * View to edit
 */
class VmreporterViewBycategory extends JView
{
    ...
    VmreporterHelper::addSubmenu($view);
		...
		$model = JModel::getInstance("bycategory","VmreporterModel");
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_VMREPORTER').': '.JText::_('COM_VMREPORTER_TITLE_BYCATEGORY').': '.$this->report["name"], 'bycategory.png');
		
		if (empty($this->item->id)) {
			JToolBarHelper::cancel('bycategory.cancel', 'JTOOLBAR_CANCEL');
		}
		else {
			JToolBarHelper::cancel('bycategory.cancel', 'JTOOLBAR_CLOSE');
		}
