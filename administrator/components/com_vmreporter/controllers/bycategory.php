 ...
 */
class VmreporterControllerBycategory extends JControllerForm
{

    function __construct() {
        $this->view_list = 'bycategory';
        parent::__construct();
    }
	function cancel()
	{
		$mainframe = JFactory::getApplication();
		$mainframe->redirect('index.php?option=com_vmreporter&view=bycategories');
	}
