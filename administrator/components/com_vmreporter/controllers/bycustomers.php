 ...
 */
class VmreporterControllerBycustomers extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'bycustomers', $prefix = 'VmreporterModel')
	{
	...
	function delete()
	{
		...
		$sql = "DELETE from #__vmreporter_bycustomer WHERE id IN (".implode(',',$report_ids).")";
		$db->setQuery($sql);
		$db->query();
		$mainframe->redirect('index.php?option=com_vmreporter&view=bycustomers','deleted');
	}
