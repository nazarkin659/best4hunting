 ...
 */
class VmreporterControllerBymanufacturer extends JControllerForm
{

    function __construct() {
        $this->view_list = 'bymanufacturer';
        parent::__construct();
    }
	function cancel()
	{
		$mainframe = JFactory::getApplication();
		$mainframe->redirect('index.php?option=com_vmreporter&view=bymanufacturers');
	}
