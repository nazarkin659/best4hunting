 ...
 */
class VmreporterControllerByproduct extends JControllerForm
{

    function __construct() {
        $this->view_list = 'byproducts';
        parent::__construct();
    }
	function cancel()
	{
		$mainframe = JFactory::getApplication();
		$mainframe->redirect('index.php?option=com_vmreporter&view=byproducts');
	}
