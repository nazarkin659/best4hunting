		...
		<h4 class="toggler <?php echo $iceaccordion_toggler ?>">
			...
			<div class="accordion_content <?php echo $iceaccordion_content ?>">
                	<div class="virtuemart_padding padding">
						<div class="<?php echo $show_preview?'iceAccordionTip':''; ?>" style=" width:<?php echo $imageWidth; ?>px; height:<?php echo $imageHeight;?>px"rel="<?php echo $show_preview?$item->thumbnail:'';?>" title="<?php echo  $show_preview?$item->title:'';?>">
