...
window.addEvent('load', function(){
	...
	$$("#jform_params_k2_source_from").addEvent("change",function(){
 		updateSourceFrom("#jform_params_k2_source_from");
 	});
	$$("#jform_params_exp_source_from").addEvent("change",function(){
 		updateSourceFrom("#jform_params_exp_source_from");
 	});
	$$(".source_from").addEvent("change",function(){
 		updateSourceFrom(".source_from");
 	});
 	updateSource();
	updateSourceFrom( "#jform_params_ip_source_from" );
	updateSourceFrom( "#jform_params_k2_source_from" );
