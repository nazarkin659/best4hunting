 ...
 */
if( !class_exists('IceGroupAccordionVirtuemart') ) {
	/**
   * IceGroupCarouselJoomshopping Class  extends the LofSliderGroupBase Class
   */   
   class IceGroupAccordionVirtuemart extends IceAccordionGroupBase{
    ...
    public function getListByParameters( $params ){
      if( !IceGroupAccordionVirtuemart::isVmExisted() ){
        return array();
      }
    ...
    public function __getList( $params ){
      ...
      foreach( $products as $key => $item ){
		...
		$check[] = $item->virtuemart_product_id;
		$data[] = $item;
      }
      return $data; 
    }
