...
-------------------- 2.5.2 Stable Release [7-May-2012] ------------------
	#- We have fixed this BUG
		#174 Ajax issue.Images are not showing because the path it is not reading.
...
-------------------- 1.7.1 Stable Release [22-December-2011] ----------------

	- Added support for JomSocial component
	#- We have fixed this BUG
		#162 Problems with two accordions in a same page
