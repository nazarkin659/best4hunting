		...
		<div class="lof-inner">
			...
			<a <?php echo $target;?>  href="<?php echo $item->link;?>" title="<?php echo $item->title;?>"><?php echo $item->title ?></a></h4>
				<div class="carousel_content">
					...
					<div class="<?php echo $vm_show_preview?'iceTip':''; ?>" style=" width:<?php echo  $imageWidth ;?>px ;height: <?php echo $imageHeight;?>px" rel="<?php echo $vm_show_preview?$item->thumbnail:'';?>" title="<?php echo  $vm_show_preview?$item->title:'';?>">
					<?php
					...
					<?php if( $vm_show_price ): ?>
						<div class="vm_price"><?php echo JText::_("SALE_PRICE")."<span>".$item->product_price."</span>"; ?></div>
					<?php endif; ?>
