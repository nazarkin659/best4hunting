 ...
 */
if( !class_exists('IceGroupCarouselExpautos') ) {
	...
	/**
   * IceGroupCarouselExpautos Class  extends the LofSliderGroupBase Class
   */   
   
   class IceGroupCarouselExpautos extends IceGroupBase{
    ...
    public function getListByParameters( $params ){
      if( !IceGroupCarouselExpautos::isExpExisted() ){
        return array();
      }
