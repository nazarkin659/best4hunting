...
dojo.declare("FontConfigurator", null, {
  ...
  showWindow: function(e){
    ...
    if(!this.window){
      ...
      dojo.create('div', {'class': 'OfflajnWindowField', 'innerHTML': 'Text-decoration<br />'+this.elements.textdecor['html']}, fields);
...
jQuery.fn.jPicker.defaults.images.clientPath="http://66.225.214.212/administrator/../modules/mod_improved_ajax_login/params/offlajncolor/offlajncolor/jpicker/images/";
